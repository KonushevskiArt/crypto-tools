...
const InterestCalculator = () => {
  ...
  const onSubmit = ({ entryPrice, closingPrice }) => {
    const currentRes = entryPrice > closingPrice ?
      ...
      > 
        ...
        >
          <TextField
            ...
            helperText={errors && errors.entryPrice ? errors.entryPrice.message : null}
          />
          <Typography pr='20px' pl='20px'>{result}%</Typography>
          ...
          <TextField
            ...
            helperText={errors && errors.closingPrice ? errors.closingPrice.message : null}
          />
        </Box>
        <Button
            size="small"
