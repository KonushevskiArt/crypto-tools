        ...
        <Accordion 
          ...
          >
            ...
            <Box sx={{"display": 'flex', 'alignItems': 'center', 'justifyContent': 'space-between', 'width': '100%'}}>
              ...
              <Box sx={{display: "flex", justifyContent: 'space-beetwen', alignItems: 'center'}}> 
                <Box sx={{border: "1px solid black", padding: '5px 20px', borderRadius: '10px', marginRight: '40px'}}>
                  <Typography sx={{borderRight: '1px solid black', marginRight: '20px', paddingRight: '20px' }} component="span">{averagePrice(currencies[currencyName]) || 0}</Typography>
                  <Typography sx={{borderRight: '1px solid black', marginRight: '20px', paddingRight: '20px' }} component="span">{totalQuantity(currencies[currencyName]) || 0}</Typography>
                  <Typography component="span">{totalCosts(currencies[currencyName]) || 0}</Typography>
